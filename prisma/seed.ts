  ...
  try {
    const mousesCategory = await prisma.category.create({
      data: {
        name: 'Mouses',
        slug: 'mouses',
        image_url: 'https://fsw-store.s3.sa-east-1.amazonaws.com/mouses.png',
      },
    })
    ...
    const keyboardsCategory = await prisma.category.create({
      data: {
        name: 'Teclados',
        slug: 'keyboards',
        image_url: 'https://fsw-store.s3.sa-east-1.amazonaws.com/keyboards.png',
      },
    })
    ...
    const keyboards = [
      ...
      },
      {
        ...
        base_price: 440,
        category_id: keyboardsCategory.id,
        discount_percent: 5, // 10% discount
      },
      {
        ...
        base_price: 700,
        category_id: keyboardsCategory.id,
        discount_percent: 15, // 10% discount
      },
      {
        name: 'Epomaker TH80',
        slug: 'epomaker-th80',
      ...
      },
      {
        ...
        base_price: 400,
        category_id: keyboardsCategory.id,
        discount_percent: 25, // 10% discount
      },
    ]
    ...
    const headphonesCategory = await prisma.category.create({
      data: {
        ...
        slug: 'headphones',
        image_url:
          'https://fsw-store.s3.sa-east-1.amazonaws.com/headphones.png',
      },
    })
    ...
    const headphones = [
      ...
      },
      {
        ...
        base_price: 250,
        category_id: headphonesCategory.id,
        discount_percent: 0, // 10% discount
      },
      {
        name: 'Razer Kraken X',
        slug: 'razer-kraken-x',
    ...
    const mousepadsCategory = await prisma.category.create({
      data: {
        name: 'Mousepads',
        slug: 'mousepads',
        image_url: 'https://fsw-store.s3.sa-east-1.amazonaws.com/mousepads.png',
      },
    })
    ...
    const mousepads = [
      {
        ...
        base_price: 950,
        category_id: mousepadsCategory.id,
        discount_percent: 10, // 10% discount
      },
      {
    ...
    const monitorsCategory = await prisma.category.create({
      data: {
        name: 'Monitores',
        slug: 'monitors',
        image_url: 'https://fsw-store.s3.sa-east-1.amazonaws.com/monitors.png',
      },
    })
    ...
    const speakersCategory = await prisma.category.create({
      data: {
        name: 'Speakers',
        slug: 'speakers',
        image_url: 'https://fsw-store.s3.sa-east-1.amazonaws.com/speakers.png',
      },
    })
